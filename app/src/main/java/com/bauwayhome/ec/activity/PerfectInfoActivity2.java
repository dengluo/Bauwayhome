...
import com.bauwayhome.ec.View.WheelNumDialog;
...
public class PerfectInfoActivity2 extends BaseActivity implements WheelNumDialog.OnDialogBackListener {
    ...
    private static final String TAG = "PerfectInfoActivity2";
        ...
        user.update(objectId, new UpdateListener() {
            ...
            public void done(BmobException e) {
                if (e == null) {
                    ...
                    startActivity(new Intent(PerfectInfoActivity2.this, LoginActivity.class));
