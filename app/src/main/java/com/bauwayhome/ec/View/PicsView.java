...
public class PicsView extends RelativeLayout {
    ...
    private int pointW = 4;
    private int pointH = 4;
    ...
    private void initData() {
        ...
        LayoutParams llP = new LayoutParams(WRAP_CONTENT, WRAP_CONTENT);
        ...
        LayoutParams llT = new LayoutParams(WRAP_CONTENT, WRAP_CONTENT);
