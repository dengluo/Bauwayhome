...
public class Product_Small extends BmobObject{
    ...
    public Product_Small() {
        this.setTableName("Product_Small");
    }
    public Product_Small(String iqos_name, String iqos_size, String iqos_model, String iqos_battery, BmobFile iqos_image ) {
