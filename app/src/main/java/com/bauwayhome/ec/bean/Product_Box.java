...
public class Product_Box extends BmobObject{
    ...
    public Product_Box() {
        this.setTableName("Product_Box");
    }
    public Product_Box(String iqos_name, String iqos_size, String iqos_model, String iqos_battery, BmobFile iqos_image ) {
