...
public class VideoMoreAdapter extends BaseAdapter {
    ...
    public VideoMoreAdapter(Context mContext, List<Video> videoList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        Glide.with(mContext).load(videoList.get(position).getVideoImg()).priority(Priority.HIGH).into(viewHolder.videoImg);
        return view;
    }
